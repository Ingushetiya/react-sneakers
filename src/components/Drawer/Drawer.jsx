  ...
  const onClickOrder = async () => {
    try {
      ...
      const { data } = await axios.post(
        `https://63813f8f9440b61b0d14b16c.mockapi.io/orders`,
        {
          item: cartItems,
        }
      );
      ...
      for (let i = 0; i < cartItems.length; i++) {
        ...
        await axios.delete(
          `https://63813f8f9440b61b0d14b16c.mockapi.io/cart/` + item.id
        );
        await delay(1000);
      }
    } catch (error) {
      ...
      <div className={styles.drawer}>
        ...
        {items.length > 0 ? (
          ...
          <Info
            ...
            img={isOrderCompleted ? "assets/cardComp.svg" : "assets/box.jpg"}
          />
        )}
      </div>
    </div>
